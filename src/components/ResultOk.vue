...
<template>
  <section class="flex min-h-full w-full flex-col items-center bg-green-50 px-4 py-8 sm:px-6 sm:py-10">
    <div class="flex w-full max-w-[1095px] min-h-[698px] flex-col rounded-lg border border-green-300 bg-white p-6">
      <h2 class="text-xl font-semibold text-green-900">Complimenti, hai superato il quiz!</h2>
